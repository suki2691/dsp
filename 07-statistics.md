...
------------|----------
Depends on likelihood of observed data | Depends on prior and likelihood of observed data
Does not use probabilities for hypotheses | Uses probabilities for hypotheses and data
No need for prior information | needs prior information
